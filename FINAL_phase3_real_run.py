"""
FINAL PHASE 3 ANALYSIS - Using Your Actual Module with Real Data

This script:
1. Loads YOUR actual Phase 2 module (06_pyomo_DTC_CPLEX_TES.py)
2. Uses REAL data from gjt_working.xlsx
3. Runs proper Phase 3 analysis
4. Generates final deliverables

This is the REAL Phase 3, not synthetic analysis!
"""
...
print("="*80)
print("FINAL PHASE 3 ANALYSIS - Using Your Actual TES Module")
print("="*80)
...
vars_config = {
    ...
    'window_size': 168,     # 7-day windows (1 week)
...
try:
    ...
    if use_module:
        ...
        results_df.to_csv(f"{output_dir}/FINAL_phase3_dispatch_results.csv", index=True)
        print(f"✓ Results saved: FINAL_phase3_dispatch_results.csv")
        ...
        with open(f"{output_dir}/FINAL_phase3_results_summary.json", 'w') as f:
            json.dump(summary, f, indent=2)

        print(f"✓ Summary saved: FINAL_phase3_results_summary.json")
        print()
        print("="*80)
