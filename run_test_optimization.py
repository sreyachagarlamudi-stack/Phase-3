"""
Test Optimization: tes_st_min = 25%

This script runs the full-year optimization with improved turndown.
...
print("="*80)
print("TEST OPTIMIZATION: tes_st_min = 25%")
print("="*80)
...
excel_file = "/Users/sreyachagarlamudi/Downloads/(PtXv3.4_r0) gjt_working_test25.xlsx"
...
print(f"  tes_st_min: {tes_params.get('tes_st_min', 25)}%")
...
vars_config = {
    ...
    'tes_st_min': float(tes_params.get('tes_st_min', 25.0)),
    'tes_soci': 0.30,
...
print(f"Test: tes_st_min = {vars_config['tes_st_min']}%\n")
...
try:
    ...
    summary = {
        ...
        'configuration': 'Test (25% min load)',
